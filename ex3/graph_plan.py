...
def independent_pair(a1, a2):
    ...
    """
    # interfere:
    if np.any(np.intersect1d(a1.get_pre(), a2.get_delete())) or np.any(np.intersect1d(a1.get_delete(), a2.get_pre())):
        return False
    # inconsistent effects:
    if np.any(np.intersect1d(a1.get_add(), a2.get_delete())) or np.any(np.intersect1d(a1.get_delete(), a2.get_add())):
        return False
    return True
    ...
    #         return False
    # for p in a1.get_delete():
    #     if a2.is_pos_effect(p):
    #         return False
    # for p in a2.get_add():
    #     if a1.is_neg_effect(p):
    #         return False
    # for p in a2.get_delete():
    #     if a1.is_pos_effect(p):
    #         return False
    # return True
