...
class PyFenseHud(cocos.layer.Layer, pyglet.event.EventDispatcher):
    ...
    def _display_status_bar(self):
        ...
        self.genLabel = cocos.text.Label('Current gen: 1', bold=True,
                                          anchor_x='center',
                                          anchor_y='center',
                                          font_size=13)
        ...
        self.genLabel.position = w / 2 - 220, h - 30
        self.add(self.waveLabel)
        self.add(self.genLabel)
        ...
        self.currentCurrency = 302  # todo: changed to 302 for testing, first population is not displayed correctly
    ...
    def update_gen_number(self, gen_num):
        """Updates the number of the current Wave displayed in the Statusbar"""
        self.genLabel.element.text = ('Current Gen: ' + str(gen_num))
    ...
    def start_next_wave_timer(self):
        ...
        self.schedule_interval(self._update_next_wave_timer, 0)
